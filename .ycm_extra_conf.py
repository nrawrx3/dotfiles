# Example .ycm_extra_conf.py file. I will add the include directories to the
# INCLUDES_WRT_TOP_LEVEL list relative to the top level directory of the
# project where this file should reside.

# Also, sometimes ycm doesn't seem to find the system includes by itself. I
# use gcc so the includes are in /usr/include/c++/<GCC_VERSION>/...
...
# ---- End of NixOS related

SOURCE_DIR = os.getcwd()

# EDIT THIS LIST HERE
INCLUDES_WRT_TOP_LEVEL = [
    'glfw/include',
    'include'
]

INCLUDES = [os.path.join(SOURCE_DIR, include_dir) for include_dir in INCLUDES_WRT_TOP_LEVEL]
