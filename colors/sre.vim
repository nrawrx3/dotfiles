...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "ffffff", "710101", "")
    ...
    " Syntax Elements
    call <SID>X("String", "710073", "", "")
    call <SID>X("Constant", "710073", "", "")
    call <SID>X("Number", "710073", "", "")
    call <SID>X("Statement", "ad004c", "", "")
    call <SID>X("Function", "000000", "", "")
    call <SID>X("PreProc", "ad004c", "", "")
    call <SID>X("Comment", "001fef", "", "")
    call <SID>X("Type", "ad004c", "", "")
    call <SID>X("Error", "ffffff", "d40000", "")
    call <SID>X("Identifier", "000000", "", "")
    call <SID>X("Label", "000000", "", "")

    " Python Highlighting
    "call <SID>X("pythonCoding", "000000", "", "")
    "call <SID>X("pythonRun", "000000", "", "")
